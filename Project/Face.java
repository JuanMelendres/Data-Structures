...
public class Face extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Apple Casual", 3, 12));
        ...
        jLabel1.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel1.setText("Num of Jobs");

        numOfJobs.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        jLabel2.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Algorithm");

        AlgorithmsMenu.setFont(new java.awt.Font("Apple Casual", 1, 12));
        AlgorithmsMenu.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"FCFS", "SJF"}));
        ...
        stopBttn.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        nextStepBttn.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        restartBttn.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        anotherSimBttn.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        finishBttn.setFont(new java.awt.Font("Apple Casual", 1, 12));
        ...
        jLabel7.setFont(new java.awt.Font("Apple Casual", 1, 24));
        ...
        jLabel5.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Current job");

        jLabel6.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Current Time");

        cpuCurrentJob.setBackground(new java.awt.Color(255, 255, 255));
        cpuCurrentJob.setFont(new java.awt.Font("Apple Casual", 1, 20));
        cpuCurrentJob.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        cpuCurrentJob.setText("Idle");

        cpuCurrentTime.setFont(new java.awt.Font("Apple Casual", 1, 20));
        cpuCurrentTime.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        cpuCurrentTime.setText("0");

        jLabel8.setFont(new java.awt.Font("Apple Casual", 1, 24));
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("CPU");

        jLabel9.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Utilization");

        cpuUtilize.setFont(new java.awt.Font("Apple Casual", 1, 20));
        ...
        jLabel10.setFont(new java.awt.Font("Apple Casual", 1, 24));
        ...
        jLabel11.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("Waiting");

        jLabel12.setFont(new java.awt.Font("Apple Casual", 1, 14));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("Turnaround");

        AverWait.setBackground(new java.awt.Color(255, 255, 255));
        AverWait.setFont(new java.awt.Font("Apple Casual", 1, 20));
        AverWait.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AverWait.setText("0");

        AverTurn.setFont(new java.awt.Font("Apple Casual", 1, 20));
        AverTurn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AverTurn.setText("0");

        jLabel13.setFont(new java.awt.Font("Apple Casual", 1, 24));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Untitled-1.png")));
        jLabel14.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Untitled3.png")));
    ...
    */
    private void nextStepBttnActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if(Simulation.finished){
            finishBttnActionPerformed(null);
        }
